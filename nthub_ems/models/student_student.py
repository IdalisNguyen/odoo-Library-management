...
#    id_student = fields.Char(string="ID Student", size=256, related='code.id_student',readonly=True)
    id_student = fields.Many2one('res.users', string='Student User', default=lambda self: self.env.user)

    email_student = fields.Char(string="Email ",size=256,related='user_id.login',readonly=True)
    ...
    army_state = fields.Selection([("Bắc", "Miền Bắc"), ("Nam", "Miền Nam"), ("Trung", "Miền Trung")])
    # nationality = fields.Selection([("viet nam", "Việt Nam"), ("other", "Other")], default="Việt Nam")
    nationality = fields.Selection([
        ('vi', 'Việt Nam'),
        ('oth', 'Other'),
        # thêm các lựa chọn khác nếu cần
    ], string='Nationality', default="vi")
    ...
    id_student = fields.Char(string=_('ID Student'))
